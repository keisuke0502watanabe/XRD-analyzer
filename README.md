...
**Current version:** [`xrd_analyzer_v25.html`](xrd_analyzer_v25.html)
...
`http://localhost:8753/xrd_analyzer_v25.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v25.html`.
