...
**Current version:** [`xrd_analyzer_v22.html`](xrd_analyzer_v22.html)
...
`http://localhost:8753/xrd_analyzer_v22.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v22.html`.
