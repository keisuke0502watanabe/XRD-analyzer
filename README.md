...
**Current version:** [`xrd_analyzer_v24.html`](xrd_analyzer_v24.html)
...
`http://localhost:8753/xrd_analyzer_v24.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v24.html`.
