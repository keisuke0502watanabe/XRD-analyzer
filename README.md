...
**Current version:** [`xrd_analyzer_v26.html`](xrd_analyzer_v26.html)
...
`http://localhost:8753/xrd_analyzer_v26.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v26.html`.
