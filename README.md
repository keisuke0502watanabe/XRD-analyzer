...
**Current version:** [`xrd_analyzer_v27.html`](xrd_analyzer_v27.html)
...
`http://localhost:8753/xrd_analyzer_v27.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v27.html`.
