...
**Current version:** [`xrd_analyzer_v23.html`](xrd_analyzer_v23.html)
...
`http://localhost:8753/xrd_analyzer_v23.html`.
...
Then open `http://localhost:8753/xrd_analyzer_v23.html`.
